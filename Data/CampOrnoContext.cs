...
namespace CampOrno.Data
{
    public class CampOrnoContext : DbContext
    {
       ...
       : base(options)
        ...
        public DbSet<CamperActivity> CamperActivities { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //For Part 5, we probably want to avoid
            //adding the same activity to the camper twice!
            //Example of "need to ask the client"
            modelBuilder.Entity<CamperActivity>()
                .HasIndex(c => new { c.CamperID, c.ActivityID })
                .IsUnique();
